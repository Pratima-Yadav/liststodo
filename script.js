...
function insertNewRecord(data) {
   ...
   cell2.innerHTML = (index+1);
    ...
    cell5.innerHTML =new Date().toLocaleString('en-us', {weekday: 'short'})+""+
...
function updateRecord(formData) {
    ...
    selectedRow.cells[4].innerHTML = formData.timestamp;
}
...
function validate() {
    isValid = true;
    if (document.getElementById("name").value == "" || document.getElementById("degree").value =="" ||document.getElementById("city").value == "") {
        isValid = false;
